...
export async function POST(req: Request) {
  ...
  try {
    ...
    const allowedPrefixes = ["/api/subscribers", "/api/billing-date", "/api/giveaway", "/api/organizers", "/api/contributor-activity", "/api/referrals", "/api/digest", "/api/claims", "/api/approvals", "/api/listings", "/api/organizer-apply", "/api/admin-link-organizer"];
