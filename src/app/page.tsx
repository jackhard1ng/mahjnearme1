...
import { Search, MapPin, Sparkles, Globe, ShieldCheck, Bell, ArrowRight, Star } from "lucide-react";
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-teal-50 via-white to-white">
        <div className="absolute inset-0 opacity-5" style={{ backgroundImage: "radial-gradient(circle at 20% 50%, #0d9488 1px, transparent 1px)", backgroundSize: "40px 40px" }} />
        <div className="max-w-5xl mx-auto px-4 pt-16 pb-12 sm:pt-24 sm:pb-16 text-center relative">
          <h1 className="font-[family-name:var(--font-heading)] font-extrabold text-4xl sm:text-5xl lg:text-6xl text-slate-900 mb-4 tracking-tight">
            ...
            <span className="text-teal-600">Anywhere You Go</span>
          </h1>
          ...
          <p className="text-sm text-slate-400">
            <span className="font-semibold text-teal-600">{stats.gameCount} games</span> across{" "}
            <span className="font-semibold text-teal-600">{stats.cityCount} cities</span> and counting
          </p>
        </div>
      </section>

      {/* City Marquee */}
      <section className="py-6 border-y border-slate-100 overflow-hidden bg-slate-50">
          ...
          <div className="animate-scroll-left whitespace-nowrap flex">
            {[...cities, ...cities].map((city, i) => (
              <Link
                ...
                className="inline-flex items-center px-6 text-slate-500 hover:text-teal-600 transition-colors text-sm font-medium"
              >
                <span className="w-1.5 h-1.5 bg-teal-400 rounded-full mr-3" />
                {city}
              </Link>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-xs font-bold text-teal-600 uppercase tracking-wider mb-2">Step 1</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-coral-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                <MapPin className="w-7 h-7 text-coral-500" />
              </div>
              <div className="text-xs font-bold text-coral-500 uppercase tracking-wider mb-2">Step 2</div>
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid sm:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              <Bell className="w-8 h-8 text-teal-600 mb-4" />
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-4">
          <div className="bg-gradient-to-br from-teal-50 to-white rounded-2xl p-8 sm:p-10 border border-teal-100">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Organizer CTA */}
            <div className="rounded-2xl bg-gradient-to-br from-coral-50 to-white p-8 border border-orange-100 text-center">
            ...
            {/* Player CTA */}
            <div className="rounded-2xl bg-gradient-to-br from-teal-50 to-white p-8 border border-teal-100 text-center">
              <h3 className="font-[family-name:var(--font-heading)] font-bold text-2xl text-slate-900 mb-3">
          ...
          <div className="text-center mt-10">
            <Link href="/shop" className="text-teal-600 hover:text-teal-700 font-medium transition-colors inline-flex items-center gap-2">
