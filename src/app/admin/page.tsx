    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-3">
          <Link
            href="/admin/games"
            className="flex items-center gap-2 bg-lavender-100 border border-lavender-200 px-4 py-2 rounded-lg text-sm font-medium text-slate-700 hover:bg-skyblue-100 transition-colors"
          >
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-lavender-100 border border-lavender-200 rounded-xl p-5">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs font-medium text-mint-500 bg-mint-100 px-2 py-0.5 rounded-full">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Unverified Listings */}
        <div className="bg-lavender-100 border border-lavender-200 rounded-xl">
            ...
            {unverifiedList.length === 0 ? (
              ...
              unverifiedList.map((game) => (
                <div key={game.id} className="px-5 py-3 flex items-center justify-between">
                  ...
                  <button className="flex items-center gap-1 bg-mint-100 hover:bg-mint-200 border border-mint-300 rounded-lg px-3 py-1.5 text-xs font-medium text-mint-600 transition-colors">
        ...
        <div className="space-y-4">
          <div className="bg-lavender-100 border border-lavender-200 rounded-xl">
            <div className="px-5 py-4 border-b border-lavender-100">
              <h2 className="font-semibold text-charcoal">Quick Actions</h2>
            </div>
            <div className="p-5 grid grid-cols-2 gap-3">
              <Link
                href="/admin/games?action=new"
                className="flex flex-col items-center gap-2 bg-skyblue-50 hover:bg-softpink-100 border border-lavender-200 hover:border-mint-300 rounded-xl p-4 transition-colors"
              >
          ...
          <div className="bg-lavender-100 border border-lavender-200 rounded-xl">
            <div className="px-5 py-4 border-b border-lavender-100 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 text-xs">
                <span className="text-mint-500 font-medium">{verifiedGames} verified</span>
              ...
              {recentlyVerified.map((game) => (
                <div key={game.id} className="px-5 py-3 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {game.promoted && (
                      <span className="inline-flex items-center gap-1 text-xs font-medium text-gold-600 bg-gold-100 border border-gold-200 rounded-full px-2 py-0.5">
              ...
              {[
                ...
                <div key={i} className="px-5 py-3 flex items-center justify-between">
                  ...
                  <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${
                    ...
                    signup.type === "organizer" ? "bg-lavender-100 text-lavender-600" :
