          ...
          <div key={sub.id} className="bg-white border border-slate-200 rounded-xl p-5">
            <div className="flex items-start justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button className="flex items-center gap-1.5 bg-skyblue-100 hover:bg-hotpink-200 border border-hotpink-200 rounded-lg px-4 py-2 text-sm font-medium text-hotpink-600 transition-colors">
