...
const initialSubmissions = [
  {
    id: "s1",
    name: "Stillwater Mahj Meetup",
    organizer: "Susan K.",
    city: "Stillwater, OK",
    submitted: "2 hours ago",
    type: "Open Play",
    email: "susan.k@example.com",
    description: "Weekly American Mahjong open play at the Stillwater community center. All levels welcome. Sets provided.",
    venue: "Stillwater Community Center",
    day: "Saturday",
  ...
  {
    id: "s2",
    name: "Bartlesville Tiles & Tea",
    organizer: "Yuki T.",
    city: "Bartlesville, OK",
    submitted: "1 day ago",
    type: "Open Play",
    email: "yuki.t@example.com",
    description: "Casual mahjong at the tea house every Friday night. All styles welcome.",
    venue: "Bartlesville Tea House",
    day: "Friday",
