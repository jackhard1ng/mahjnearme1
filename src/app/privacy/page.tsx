  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">1. Information We Collect</h2>
        ...
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">2. How We Use Your Information</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">3. Location Data</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">4. Cookies & Analytics</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">5. Third-Party Services</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">6. Data Security</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">7. Your Rights</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-semibold text-xl text-slate-800 mb-3">8. Contact</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
