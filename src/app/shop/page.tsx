...
export default function ShopPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      {/* Featured Products */}
      <h2 className="font-semibold text-xl text-slate-800 mb-4 flex items-center gap-2">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 bg-coral-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-coral-600 transition-colors"
                >
      ...
      {/* All Products */}
      <h2 className="font-semibold text-xl text-slate-800 mb-4">All Products</h2>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-coral-500 hover:text-coral-600 font-semibold inline-flex items-center gap-1"
                >
