      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/search" className="text-slate-600 hover:text-teal-600 transition-colors text-sm font-medium">
              Find Games
            </Link>
            <Link href="/cities" className="text-slate-600 hover:text-teal-600 transition-colors text-sm font-medium">
              Cities
            </Link>
            <Link href="/shop" className="text-slate-600 hover:text-teal-600 transition-colors text-sm font-medium">
              Mahj Gear
            </Link>
            <Link href="/add-your-group" className="text-slate-600 hover:text-teal-600 transition-colors text-sm font-medium">
              For Organizers
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-slate-100 py-4 space-y-3">
            <Link
              ...
              className="block px-3 py-2 text-slate-700 hover:bg-slate-50 rounded-lg font-medium"
            >
              Find Games
            </Link>
            <Link
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="block px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg font-medium w-full text-left"
                >
                  Sign Out
                </button>
              </>
              ...
              <div className="space-y-2 px-3">
                ...
                <Link
                  href="/signup"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block text-center py-2 bg-teal-600 text-white rounded-lg font-semibold"
                >
                  Start Free Trial
                </Link>
              </div>
