      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg text-white">MahjNearMe</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/search" className="text-sm hover:text-teal-400 transition-colors">
                  Find Games
                </Link>
              </li>
              <li>
                <Link href="/cities" className="text-sm hover:text-teal-400 transition-colors">
                  Browse Cities
                </Link>
              </li>
              <li>
                <Link href="/shop" className="text-sm hover:text-teal-400 transition-colors">
                  Mahj Gear
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/add-your-group" className="text-sm hover:text-teal-400 transition-colors">
                  List Your Group
                </Link>
              </li>
              <li>
                <Link href="/organizer" className="text-sm hover:text-teal-400 transition-colors">
                  Organizer Dashboard
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-slate-800 mt-10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="text-slate-400 hover:text-teal-400 transition-colors" aria-label="Twitter/X">
